...
export default class RichTextToolbarWidget extends BaseWidget {
    context: Context;
    mindMap: any;
    config: Config;
    ...
    $strikeBtn: any;
    $removeFormatBtn: any;
    onRichTextSelectionChange: (hasRange: any, rect: any, formatInfo: any) => void;
    toggleBold: () => void;
    toggleItalic: () => void;
    toggleUnderline: () => void;
    toggleStrike: () => void;
    removeFormat: () => void;
    declare $widget: JQuery<HTMLElement>;
	constructor(opt:{context:Context, mindMap:typeof MindMap, i18n: i18n}){
        super();
    ...
    registerEvent() {
        ...
        this.$boldBtn.attr("title", this.i18n.t("richTextToolbar", "bold"));
        
        this.$italicBtn.click(this.toggleItalic);
        this.$italicBtn.attr("title", this.i18n.t("richTextToolbar", "italic"));
        
        this.$underlineBtn.click(this.toggleUnderline);
        this.$underlineBtn.attr("title", this.i18n.t("richTextToolbar", "underline"));
        
        this.$strikeBtn.click(this.toggleStrike);
        this.$strikeBtn.attr("title", this.i18n.t("richTextToolbar", "strike"));
        
        this.$removeFormatBtn.click(this.removeFormat);
        this.$removeFormatBtn.attr("title", this.i18n.t("richTextToolbar", "removeFormat"));
    }
